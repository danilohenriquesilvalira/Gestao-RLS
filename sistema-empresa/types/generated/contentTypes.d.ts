...
export interface ApiDocumentoDocumento extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tipo: Attribute.Enumeration<
      ['contrato', 'recibo_vencimento', 'certificado', 'outros']
    >;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::documento.documento',
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    data_admissao: Attribute.Date;
    despesa: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::despesa.despesa'
    >;
    documento: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::documento.documento'
    >;
    ...
    nif: Attribute.String & Attribute.Required;
    nomecompleto: Attribute.String & Attribute.Required;
    password: Attribute.Password &
      Attribute.Private &
      Attribute.SetMinMaxLength<{
        minLength: 6;
